...
export function generateQuizQuestions(count: number = 20): Question[] {
  ...
  mockMatches.forEach(match => {
    ...
    pool.push({
      ...
      correctAnswer: match.collective.possessionA > 50 ? match.teamA : (match.collective.possessionA < 50 ? match.teamB : "Empate / Draw"),
    ...
    pool.push({
      ...
      correctAnswer: match.collective.crossesA > match.collective.crossesB ? match.teamA : (match.collective.crossesA < match.collective.crossesB ? match.teamB : "Ambos por igual / Both equal"),
    ...
    pool.push({
      ...
      correctAnswer: match.collective.shotsOnTargetA > match.collective.shotsOnTargetB ? match.teamA : (match.collective.shotsOnTargetA < match.collective.shotsOnTargetB ? match.teamB : "Ambos por igual / Both equal"),
      options: generateSimpleMatchOptions(match),
